...
function createScene() {
    ...
    var light = new BABYLON.DirectionalLight("lighty", new BABYLON.Vector3(0, -0.2, .2), scene);
    ...
    particleSystem = new BABYLON.ParticleSystem("paticles", 2000, scene);
